...
<main className='p-3 max-w-4xl mx-auto'>
    ...
    <form className='flex flex-col sm:flex-row gap-4'>
        ...
        <div className='flex flex-wrap gap-6'>
            ...
            <div className='flex items-center gap-2'>
                <input type='number' id='bathrooms' min='1' max='5' required className='p-3 border border-gray-300 rounded-lg'/>
                <p>Baths</p>
            </div>
 ...
 <input type='number' id='discountPrice' min='1' max='10' required className='p-3 border border-gray-300 rounded-lg'/>
        ...
        <div className='flex flex-col flex-1 gap-4'>
            ...
            <div className='flex gap-4'>
                <input className='p-3 border border-gray-300 w-full' type='file' id='images' accept='images/*' multiple />
                <button className='p-3 text-green-700 border border-green-700 rounded uppercase hover:shadow-lg disabled:opacity-80'>Upload</button>
            </div>
            <button className='p-3 bg-slate-700 text-white rounded-lg hover:opacity-95 diabled:opacity-80'>Create Listing</button>
            </div>
    </form>
