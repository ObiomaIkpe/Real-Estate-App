...
const handleSubmit = (e) => {
  ...
  // step 1: get the information that is already inside the URL.
  const urlParams = new URLSearchParams();

  // step 2: set URL params to what is already in the sidebardata object.
    ...
    <div className='flex flex-col md:flex-row md:min-h-screen'>
        ...
        <div className='flex gap-2 flex-wrap item-center'>
          <label className='font-semibold'>Type: </label>
            ...
            <h1 className='text-2xl font-semibold border-b p-3 text-slate-700 mt-5'>Listing Results:</h1>
